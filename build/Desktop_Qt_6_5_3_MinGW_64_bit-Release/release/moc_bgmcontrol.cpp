...
static constexpr auto qt_meta_stringdata_CLASSBGMControlENDCLASS = QtMocHelpers::stringData(
    "BGMControl"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSBGMControlENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSBGMControlENDCLASS_t qt_meta_stringdata_CLASSBGMControlENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10)   // "BGMControl"
    },
    "BGMControl"
};
